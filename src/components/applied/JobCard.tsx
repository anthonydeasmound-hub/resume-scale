    ...
    >
      ...
      {onInterviewPrepClick && (
        <button
          ...
          className="w-full mt-2 px-3 py-2 text-xs font-medium text-brand-blue bg-brand-blue-light rounded hover:bg-blue-100 transition-colors flex items-center justify-center gap-1"
        >
