...
export default function ExpandedJobCard({ job, onClose, onUpdate }: ExpandedJobCardProps) {
  ...
  // Fetch interview guide on mount
  useEffect(() => {
  ...
  const handleSaveRecruiter = async (data: {
        ...
        <div className="relative bg-white rounded-xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-hidden">
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
            {activeTab === "roadmap" && (
              <InterviewRoadmap
                interviews={{
                  interview_1: job.interview_1,
                  interview_2: job.interview_2,
                  interview_3: job.interview_3,
                  interview_4: job.interview_4,
                  interview_5: job.interview_5,
                }}
            ...
            {activeTab === "guide" && (
              isLoadingGuide ? (
                ...
                <InterviewGuideDisplay
                  jobId={job.id}
                  guide={interviewGuide}
                  generatedAt={guideGeneratedAt}
            ...
            {activeTab === "recruiter" && (
              <RecruiterInfo
                ...
                recruiterSource={job.recruiter_source}
