...
export const coralFreshMetadata: TemplateMetadata = {
  id: 'coral-fresh',
  name: 'Coral Fresh',
  category: 'creative',
  layout: 'two-column-right',
  description: 'Fresh and vibrant with coral accents',
  supportsPhoto: true,
  supportsSkillBars: false,
  supportsIcons: true,
};

export function generateCoralFreshHTML(data: ResumeData, options: TemplateOptions): string {
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .sidebar {
      width: 2.4in;
      background: linear-gradient(180deg, ${accentColor}15 0%, ${accentColor}05 100%);
      padding: 0.5in 0.3in;
    }
