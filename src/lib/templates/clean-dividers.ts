...
export const cleanDividersMetadata: TemplateMetadata = {
  id: 'clean-dividers',
  name: 'Clean Dividers',
  category: 'professional',
  layout: 'single',
  description: 'Clean single column with thin line dividers',
  supportsPhoto: false,
  supportsSkillBars: false,
  supportsIcons: true,
};

export function generateCleanDividersHTML(data: ResumeData, options: TemplateOptions): string {
